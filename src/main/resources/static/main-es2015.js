...
let ListComponent = class ListComponent {
    ...
    list(pageIndex, pageSize) {
        this.service.list(pageIndex, pageSize)
            ...
            let offset = pageInfo.number * pageInfo.size + 1;
            // put id/index on person
            this.personContent = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](data.content.map((person, index) => {
...
let PersonService = class PersonService {
    ...
    list(pageIndex, pageSize) {
        return this.http.get(this.listUrl + "?page=" + pageIndex + "&size=" + pageSize)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log("Done! List of Persons [" + pageIndex + ", " + pageSize + "]")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('listPersons', {})));
    }
    search(query) {
        return this.http.get(this.searchUrl + "?query=" + query + "&size=" + 1000)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log("Done! Search Persons [" + query + "]")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('listPersons', {})));
    }
